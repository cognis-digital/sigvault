"""Native cognis-connect emit for sigvault — forward findings to any platform.

Maps sigvault's JSON output to the canonical `Finding` and forwards it via
...
Usage:
    sigvault ... --format json | sigvault-emit --to stix
    sigvault-emit --to slack --url $WEBHOOK --dry-run < findings.json
"""
